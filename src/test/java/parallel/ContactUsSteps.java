...
public class ContactUsSteps {
	...
	private ContactUsPage contactUsPage = new ContactUsPage(DriverManager.getDriver());

	@Given("user navigates to contact us page")
	public void user_navigates_to_contact_us_page() {
		DriverManager.getDriver().get("http://automationpractice.com/index.php?controller=contact");
	}
