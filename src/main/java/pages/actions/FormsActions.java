...
//************************** BeMore Form
    ...
    private static int getPhoneNumber2() {
	Random random = new Random();
	int randomNumber = 0;
	boolean loop = true;
	while (loop) {
	    randomNumber = random.nextInt();
	    if (Integer.toString(randomNumber).length() == 10 && Integer.toString(randomNumber).startsWith("646")) {
		loop = false;
	    }
	}
	return randomNumber;
	...
	formsLocators.emailUsAgreeBtn.click();
    }
