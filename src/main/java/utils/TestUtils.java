...
public class TestUtils extends TestSetUp {
	...
	/*
	 * 1. Sheet name same as the test case name 2. Returns the row count in the
	 * sheet 3. Returns the column count in the sheet
	 */
	...
	/*
	 * We are using rowCount-1 as the first row in the excel will be header. We are
	 * using number of columns as 1 because we will be using Hashtable.
	 */
    ...
    /*
     * Use this dataprovider when we have all test cases and test data in one excel
     * sheet.
     */
